...
const char *tutorialName = "Tutorial 06 Scale";
...
glm::vec3 NullScale(float elapsedTime)
{
    return glm::vec3(1.0f, 1.0f, 1.0f);
}

glm::vec3 StaticUniformScale(float elapsedTime)
{
    return glm::vec3(4.0f, 4.0f, 4.0f);
}

glm::vec3 StaticNonUniformScale(float elapsedTime)
{
    return glm::vec3(0.5f, 1.0f, 10.0f);
}

glm::vec3 DynamicUniformScale(float elapsedTime)
{
    const float loopDuration = 3.0f;

    return glm::vec3(glm::mix(1.0f, 4.0f, CalcLerpFactor(elapsedTime, loopDuration)));
}
...
struct Instance
{
    ...
    {
        glm::vec3 theScale = CalcScale(elapsedTime);
